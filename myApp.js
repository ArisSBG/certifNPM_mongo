...
// var savePerson =  function(done) {
//   var aris = new Person({ name: 'Aris', age:22, favoriteFoods:['pizza', 'pasta']})
//   aris.save(function(err, data){
...
const createAndSavePerson = (done) => {
  ...
  person.save(function(err, data) {
    ...
    done(null, data);  // Passe l'objet 'data' au callback pour validation
  });
};
...
var arrayOfPeople = [
  ...
  { name: 'Mike Johnson', age: 35, favoriteFoods: ['Steak', 'Fries'] }
];
